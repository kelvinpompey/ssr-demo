...
function Home({ initialCount }: IndexRouteProps) {
  ...
  return (
    <div className="h-screen items-center flex-col flex justify-center dark:bg-red-500 dark:text-white">
      <div className="flex gap-6 items-center">
        <img src={GoLogo} alt="Go logo" className="h-[70px] w-[170px]" />
        <img src={ReactLogo} alt="React logo" className="h-[80px] w-[90px]" />
      </div>
      <h1 className="pt-6 mt-6 dark:text-white text-5xl font-semibold">
        Go + React
      </h1>
      <div className="py-7">
      ...
      <a href="/about" className="text-zinc-500 hover:underline">
        About
      </a>
      <a
        className="text-zinc-500 hover:underline"
        href="https://github.com/natewong1313/go-react-ssr"
        target="_blank"
      >
